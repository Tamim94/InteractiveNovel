...
define gui.main_menu_background = Transform("gui/openart-402a9a87ffde4bdcaef039f118a1dcd9.png",size=(1968, 1100))
...
define gui.textbox_yalign = 1.020
...
define gui.button_text_insensitive_color = '#ffffff'



define gui.quick_button_text_outlines = [(2, "#000000", 0, 0)]
...
# opacity
define gui.textbox_opacity = 0.8
...
init python:
    style.window.background = Frame("gui/textbox2.png",10,10)
